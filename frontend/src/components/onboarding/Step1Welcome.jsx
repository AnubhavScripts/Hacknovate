    ...
    >
      <Card className="mx-auto max-w-xl bg-slate-900/90 border-slate-800 backdrop-blur-xl">
        <CardHeader>
          ...
          <CardDescription className="mt-3 text-base text-slate-200">
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="space-y-2 text-center">
              <p className="text-sm text-slate-300">✨ <span className="text-blue-300 font-semibold">Takes about 2 minutes</span></p>
              <p className="text-sm text-slate-300">🎁 <span className="text-indigo-300 font-semibold">No credit card required</span></p>
            </div>
          </div>
        </CardContent>
      </Card>
